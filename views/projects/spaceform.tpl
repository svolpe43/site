...
% elif section == 'content':
    ...
    <div id="blog" class="no-indent">
    	...
    	<img src="/projects/spaceform/img/full_front.jpg" alt="night-distribution" width="80%">
    	<p>
		...
		<img src="/projects/spaceform/img/perm_hover2.jpg" alt="night-distribution" width="50%">
		...
		<img src="/projects/spaceform/img/zeltom.jpg" alt="night-distribution" width="80%">
		...
		<img src="/projects/spaceform/img/amazon.jpg" alt="night-distribution" width="75%">
		...
		<img src="/projects/spaceform/img/axis.jpg" alt="night-distribution" width="75%">
		...
		<img src="/projects/spaceform/img/rotation.jpg" alt="night-distribution" width="75%">
		...
		<img src="/projects/spaceform/img/circuit_diagram.png" alt="night-distribution" width="75%">

		<p>
		And then eventually got all of this working on a breadboard.
		</p>
		<img src="/projects/spaceform/img/finished_circuit.jpg" alt="night-distribution" width="50%">
		<p>
		...
		<img src="/projects/spaceform/img/board_diagram.png" alt="night-distribution" width="50%">
		<p>
		Then I got it printed by OSH Park and it turned out completely awesome.

		<img src="/projects/spaceform/img/pic7.jpg" alt="night-distribution" width="75%">
		<img src="/projects/spaceform/img/pic8.jpg" alt="night-distribution" width="75%">
		...
		<img src="/projects/spaceform/img/smd_placing_1.jpg" alt="night-distribution" width="75%">
		<p>Then I taped the pattern over the board so all of the SMD pads lined up with the holes on the pattern.</p>
		<img src="/projects/spaceform/img/smd_placing_2.jpg" alt="night-distribution" width="75%">
		<p>Then I spread paste on the pattern in one even swipe with a Chipotle gift card.</p>
		<img src="/projects/spaceform/img/smd_placing_3.jpg" alt="night-distribution" width="75%">
		<p>This puts an even layer of solder paste on all of the SMD pads.</p>
		<img src="/projects/spaceform/img/smd_placing_4.jpg" alt="night-distribution" width="75%">
		<p>Then using a book of SMD parts I carefully placed all of the SMD components onto the board. Where they need to be</p>
		<img src="/projects/spaceform/img/smd_placing_5.jpg" alt="night-distribution" width="75%">
		...
		<img src="/projects/spaceform/img/heating_gun.jpg" alt="night-distribution" width="30%">
		<p>
		...
		<img src="/projects/spaceform/img/pic6.jpg" alt="night-distribution" width="75%">
		<img src="/projects/spaceform/img/pic3.jpg" alt="night-distribution" width="75%">
		<img src="/projects/spaceform/img/pic4.jpg" alt="night-distribution" width="75%">
		<p>
		...
		<img src="/projects/spaceform/img/pic13.jpg" alt="night-distribution" width="75%">
		<img src="/projects/spaceform/img/pic14.jpg" alt="night-distribution" width="75%">

		<p>
		I bought some belts from McMaster Carr and printed some adjustable stepper mounts and it is as smooth as butter!
		</p>
		<img src="/projects/spaceform/img/pic15.jpg" alt="night-distribution" width="75%">
		...
		<img src="/projects/spaceform/img/pic12.jpg" alt="night-distribution" width="75%">
		...
		<img src="/projects/spaceform/img/full_back.jpg" alt="night-distribution" width="75%">
		...
		<img src="/projects/spaceform/img/full_front.jpg" alt="night-distribution" width="75%">
