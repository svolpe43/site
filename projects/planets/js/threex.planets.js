...
THREEx.Planets.baseURL	= '/projects/planets/threex.planets/'
...
THREEx.Planets.createStarfield	= function(){
	//var texture	= THREE.TextureLoader(THREEx.Planets.baseURL+'images/galaxy_starfield.png')
	//console.log(THREEx.Planets.baseURL+'images/galaxy_starfield.png', texture);
	var texture = new THREE.TextureLoader().load('/projects/planets/threex.planets/images/galaxy_starfield.png');
	console.log(texture);
